...
export class AdminProfileComponent {
  ...
  toggleEditMode() {
    ...
    if (this.isEditing === false) {
      ...
      this.userService.updateAdmin(this.tempProfile,this.userProfile.userId).subscribe(data => {
        console.log(data);
        this.userService.getAdmin(this.userProfile.username).subscribe(data=>{
            console.log(data);
            this.userService.setSessionStorage(data,"admin");
            this.setUserProfile();
        })
      })
    }
